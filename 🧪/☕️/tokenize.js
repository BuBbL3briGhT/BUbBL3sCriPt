...
import { tokenize, tokenTypes, Tokenizer } from '../../☕️/tokenize.js';

const { TOK_STRiNG, TOK_NUMBER, TOK_SYMBOL, TOK_KEYWORD, TOK_TRUE } =
  tokenTypes;
...
describe('tokenize(string)', function () {
  ...
  it('tokenizes true', function () {
    ...
    assert.deepEqual(
      [...tokenList],
      [{ type: TOK_TRUE, value: true, line: 1, column: 1 }],
    );
  });
  ...
  it('tokenizes string', function () {
    ...
    assert.deepEqual(
      [{ type: TOK_STRiNG, value: 'Hola Berenjena', line: 1, column: 1 }],
      [...tokens],
    );
  });
  ...
  itTokenizes(
    '(+ 7 4)(8 2 -)', // Changed description to be unique for `it`
    { type: '(', value: '(', line: 1, column: 1 },
    { type: TOK_SYMBOL, value: '+', line: 1, column: 2 },
...
describe('Tokenizer', function () {
  it('tokenizes the number 1', function () {
    ...
    assert.deepEqual(
      [{ type: 'N', value: 1, line: 1, column: 1 }],
      [...tokenizer],
    );
  });
  ...
  it('tokenizes the number 12', function () {
    ...
    assert.deepEqual(
      [{ type: 'N', value: 12, line: 1, column: 1 }],
      [...tokenizer],
    );
  });
  ...
  it('tokenizes a keyword', function () {
    ...
    assert.deepEqual(
      [{ type: 'K', value: 'keyword', line: 1, column: 1 }],
      [...tokenizer],
    );
  });
  ...
  it('tokenizes everything', function () {
    ...
    assert.deepEqual(
      [
        { type: 'S', value: 'string', line: 1, column: 1 },
        {
          type: 'Y',
          value: 'symbol',
          line: 1,
  ...
  (function () {
    ...
    it('tokenizes ' + string, function () {
      ...
      assert.deepEqual(
        { type: '(', value: '(', line: 1, column: 1, filePath: 'imaginary' },
        {
          type: 'Y',
          value: 'apple',
          line: 1,
        ...
        { type: 'Y', value: '🍏', line: 1, column: 8, filePath: 'imaginary' },
        {
          type: 'Y',
          value: 'orange',
          line: 1,
        ...
        { type: 'Y', value: '🍊', line: 1, column: 18, filePath: 'imaginary' },
        {
          type: 'Y',
          value: 'pina',
          line: 1,
        ...
        { type: 'Y', value: '🪅', line: 1, column: 26, filePath: 'imaginary' },
        { type: ')', value: ')', line: 1, column: 28, filePath: 'imaginary' },
        [...tokenizer],
      );
    });
  });
  ...
  (function () {
    const inpůt = '(83 [24 (💘 Mom) 3] JE :LL 010)';
    ...
    it('tokenizes ' + inpůt, function () {
      ...
      const expects = [
        { type: '(', value: '(', line: 1, column: 1 },
        { type: 'N', value: 83, line: 1, column: 2 },
        { type: '[', value: '[', line: 1, column: 5 },
        { type: 'N', value: 24, line: 1, column: 6 },
        { type: '(', value: '(', line: 1, column: 9 },
        { type: 'Y', value: '💘', line: 1, column: 10 },
        { type: 'Y', value: 'Mom', line: 1, column: 13 },
        { type: ')', value: ')', line: 1, column: 16 },
        { type: 'N', value: 3, line: 1, column: 18 },
        { type: ']', value: ']', line: 1, column: 19 },
        { type: 'Y', value: 'JE', line: 1, column: 21 },
        { type: 'K', value: 'LL', line: 1, column: 24 },
        { type: 'N', value: 10, line: 1, column: 28 },
        { type: ')', value: ')', line: 1, column: 31 },
      ];
...
function assertTokenizesNumber(input, expects) {
  assertTokenizes(input, { type: 'N', value: expects, line: 1, column: 1 });
}

function assertTokenizesSymbol(input, expects) {
  assertTokenizes(input, { type: 'Y', value: expects, line: 1, column: 1 });
}
