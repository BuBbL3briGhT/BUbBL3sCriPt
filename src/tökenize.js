...
// Bubblescript string tokenizer using lista as
// input.
class Tökenizer {
...
// Matches number at head of lista.
class NumberMatcher {
...
class SymbolMatcher {
  ...
  get match() {
    if (this.tortuga["isEmpty?"])
      // Cannot match a symbol on an empty lista.
...
class Char {
  static newlineChars = Lista.blow("\n", "\r");
