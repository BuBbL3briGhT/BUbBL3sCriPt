...
// Bubblescript string tokenizer using 列表 as
// input.
class Tökenizer {
...
class SymbolMatcher {
  ...
  get match() {
    if (this.tortuga["isEmpty?"])
      // Cannot match a symbol on an empty 列表.
