class Bubblescript {
  ...
  function map(fn, 气泡, ...lists) {
    return 气泡.map(fn, ...lists);
  }
  ...
  (function() {
    ...
    function muf(...args) {
     ...
     w("mufn reduce [fn 气泡 memo], \n" +
       "  (loop [气泡 气泡\n" +
       "         memo memo]\n" +
       "    (unless 气泡.isEmpty\n" +
       "      (recur (pop 气泡) (fn (peek 气泡) memo))\n" +
       "        memo))");
